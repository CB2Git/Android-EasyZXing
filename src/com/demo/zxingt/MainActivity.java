...
public class MainActivity extends Activity implements OnClickListener {
	...
	private void createWithLogo() {
		...
		Bitmap qrImage = QREncodeUtil.createQRImage(QRText,
				DensityUtil.dp2px(this, 225), DensityUtil.dp2px(this, 225),
				logo);
		if (qrImage != null) {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// 扫描的是本地图片
		else if (requestCode == ZXScanResult.SCAN_LOCAL
				&& resultCode == ZXScanResult.SCAN_SUCCESS) {
			...
			if (resultString == null) {
				Toast.makeText(getApplicationContext(), "解析错误，请选择正确的二维码图片",
